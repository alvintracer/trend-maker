...
INSERT INTO "new_Keyword" ("createdAt", "firstSeenAt", "id", "language", "lastSeenAt", "level", "normalizedText", "parentKeywordId", "pinned", "pinnedAt", "region", "sourceIdsRaw", "sourceLabel", "status", "text", "updatedAt") SELECT "createdAt", "firstSeenAt", "id", "language", "lastSeenAt", "level", "normalizedText", "parentKeywordId", "pinned", "pinnedAt", "region", "sourceIdsRaw", "sourceLabel", "status", "text", "updatedAt" FROM "Keyword";
DROP TABLE "Keyword";
